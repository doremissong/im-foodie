...
exports.checkAdmin = (req, res, next) => {
    ...
    // const memId = req.user.mem_id?req.user.mem_id:undefined;
    if (req.isAuthenticated()) {
        const memId = req.user.mem_id?req.user.mem_id:'';
        const reservedId = ['admin', 'imfoodie', 'ADMIN', 'IMFOODIE']; //*admin*, imfoodie*;

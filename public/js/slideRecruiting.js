$( document ).ready( function() {
    $('.slider-wrap-recruiting').slick({
        ...
        prevArrow: $('.prevArrow-recruiting'), //이전 화살표만 변경
        // prevArrow: "<button type='button' class='clisk-prev'>Previous</button>",
        nextArrow: $('.nextArrow-recruiting'), //다음 화살표만 변경
        ...
        speed: 400,                //모션 시간 (얼마나 빠른속도로 넘어가는지)(1000ms = 1초) 곧, 슬라이드 사이에 넘어가는 속도
